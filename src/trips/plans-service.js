...
const PlansService = {
	...
	serializePlan(plan) {
		...
		return {
			...
			formatted_address: planData.formatted_address,
			international_phone_number: planData.international_phone_number,
			...
			from_formatted_address: planData.from_formatted_address,
			from_international_phone_number: planData.from_international_phone_number,
			from_website: planData.from_website,
			to_name: planData.to_name,
			to_place_id: planData.to_place_id,
			to_utc_offset_minutes: planData.to_utc_offset_minutes,
			to_formatted_address: planData.to_formatted_address,
			to_international_phone_number: planData.to_international_phone_number,
			to_website: planData.to_website,
			comparable_date
		};
	}
}
